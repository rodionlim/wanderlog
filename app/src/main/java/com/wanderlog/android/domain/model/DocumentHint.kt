...
enum class DocumentHint(val label: String) {
    ...
    fun promptAddendum(): String = when (this) {
        ...
        HOTEL -> "The user says this document is a HOTEL/ACCOMMODATION booking. Focus extraction on hotel name, address, check-in, check-out, and booking reference. Return hotels only unless other categories are unambiguously present."
